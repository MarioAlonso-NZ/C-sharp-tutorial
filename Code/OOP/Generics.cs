...
numbers.Add(2);
numbers.Add(3);
foreach (var num in numbers.Get())
{
    Console.WriteLine(num);
}
Collection<string> strings = new Collection<string>(3);
strings.Add("M");
strings.Add("N");
strings.Add("Z");
foreach (var str in strings.Get())
{
    Console.WriteLine(str);
}
Collection<float> floats = new Collection<float>(3);
floats.Add(1.4f);
floats.Add(1.7f);
floats.Add(3.1f);
floats.Add(3.1f); 
foreach (var num in floats.Get())
{
    Console.WriteLine(num);
}
